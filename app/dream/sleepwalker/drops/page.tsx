...
export default function DropsPreviewPage() {
  ...
  const open = useMemo(() => forceOpen || isWithinWindow(now), [now, forceOpen])
        ...
        <div className="container-custom">
          ...
          {!isMember && (
            <div className="mt-8 max-w-xl mx-auto text-center">
              ...
              <a href="/dream/sleepwalker" className="btn-secondary mt-4 inline-block">Join the Club</a>
            </div>
          )}
          ...
          {isMember && !open && (
            <div className="mt-10 max-w-xl mx-auto card-gold-special p-6 rounded-xl text-center">
              ...
              <p className="mt-3 text-xs text-daze-white/50">Preview mode: add ?open=1 to URL to bypass.</p>
            </div>
          )}
